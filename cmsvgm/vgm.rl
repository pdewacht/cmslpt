...
static void output_saa1099(int);
...
action output_saa1099 { output_saa1099(vgm.arg); }
...
bool music_setup(gzFile f)
{
  ...
  unsigned long version, saa1099_hz;
  bool saa1099_stereo;
  ...
  /* SAA1099 support added in version 1.71 */
  if (version < 0x0171UL) {
    return false;
  }
  ...
  /* Check SAA1099 file */
  saa1099_hz = header[50];
  if (!saa1099_hz) {
    return false;
  }
  saa1099_stereo = saa1099_hz & 0x40000000;
  saa1099_hz &= ~0x40000000;
  if (saa1099_hz / 1000 != 7159) {
    warnx("Warning: Unexpected SAA1099 frequency %luHz", saa1099_hz);
  }
  if (!saa1099_stereo) {
    warnx("Warning: Not a stereo file");
  }
  ...
  vgm.saa1099_stereo = saa1099_stereo;
...
static void output_saa1099(int param)
{
  char address = param & 0x7F;
